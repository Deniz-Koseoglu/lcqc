...
\rohead{\usekomafont{pagefoot}{`r tpars[["tform"]]` \\Operatör: `r tpars[["oper"]]`}} 
\lohead{LC Kolon\\ Performans Raporu} 
\lofoot{Bu kolon şu ortamda gönderilmektedir:\\ `r tpars[["sp"]]`.}

<!-- [footheight=30pt] -->

\rofoot{Belge Numarası:\\ `r tpars[["dnum"]]`}
...
prodtbl <- tribble(~col1, ~col2,
               "Seri Numarası:", tpars[["sn"]],
               "Parça Numarası:", tpars[["pn"]],
               "Açıklama:", tpars[["desc"]],
               "Parti Numarası:", tpars[["bn"]])
flextable(prodtbl) |>
  delete_part("header") |>
  border_remove() |>
  width(1,1.5) |>
...
mtbl <- tribble(~col1, ~col2,
               "Mobil Faz:", tpars[["mp"]],
               "Geri Basınç:", tpars[["bp"]],
               "Akış Hızı:", tpars[["flow"]],
               "Sıcaklık:", tpars[["temp"]],
               "Enjeksiyon Hacmi:", tpars[["inj"]],
               "Test Karışımı:", tpars[["tmix"]])
flextable(mtbl) |>
  delete_part("header") |>
  border_remove() |>
  width(1,1.5) |>
