...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#FUNCTION for bulk value replacement (from the retired plyr package)
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#' @title Bulk value replacement
#' @noRd
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#FUNCTION: Add timestamp to filename
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#' @title Timestamp addition
#' @noRd
generate_filename_with_timestamp <- function(base_name) {
  timestamp <- format(Sys.time(), "%Y-%m-%d %Hhr %Mmin %Ssec")
